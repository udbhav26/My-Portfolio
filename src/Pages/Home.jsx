...
const WORDS = ["Human Computer Interaction Student", "MERN Stack Developer"];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I love to create beautiful and functional designs and bring them to life with clean and efficient code.
                </p>
                ...
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                  ...
                  <CTAButton href="mailto:udbhavm2026@gmail.com" text="Contact" icon={Mail} />
                </div>
